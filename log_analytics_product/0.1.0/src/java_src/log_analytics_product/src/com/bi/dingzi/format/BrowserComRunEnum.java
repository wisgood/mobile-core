...
public enum BrowserComRunEnum {
     ...
     * 浏览器组件的类别，0=ie-bho;1=ie-activex;2=ff-extension;3=ff-plugin "name", # 组件名称
     * "version", # 组件版本 "mac", # 本机mac地址 "guid", # 计算机计算出来的用户标识，Globally Unique
     * Identifier（全球唯一标识符） "broname", # 浏览器名称 "broversion", # 浏览器版本 "suc", #
