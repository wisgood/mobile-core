 ...
 * @Description: 安卓同步工具格式化
 * @author fuys
 * @date 2013-7-30 上午10:18:38 
 * @input:输入日志路径/2013-7-30   /dw/logs/tools/origin/sync_boot
 * @output:输出日志路径/2013-7-30 /dw/logs/tools/result/ver2/AppSyncBoot/$DIR_DAY
 * @executeCmd:hadoop jar log_analytics_product.jar com.bi.dingzi.ver2.format.AppSyncBootFormat --input $DIR_ORGINDATA_DAY_DTAIL_HOUR_INPUT --output /dw/logs/tools/result/ver2/AppSyncBoot/$DIR_DAY --inpulzo 1
 ...
 * @date 2013-7-30 上午10:18:38
 */
public class AppSyncBootFormat extends Configured implements Tool {
    ...
    public static class AppSyncBootMapper extends
...
//            if (fields.length > SyncBootEnum.GUID.ordinal()) {
                ...
                if (null != DateFormat.getAppType("1", apptypeStr)) {
...
//        }
    ...
    public static class AppSyncBootReducer extends
    ...
    public static void main(String[] args) throws Exception {
        ...
        commIsLZOArgs.init("appsyncbootformat.jar");
        commIsLZOArgs.parse(args);
        int res = ToolRunner.run(new Configuration(), new AppSyncBootFormat(),
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "5_product_dingzi_appsyncbootformat");
        job.setJarByClass(AppSyncBootFormat.class);
        FileInputFormat.setInputPaths(job, args[0]);
        FileOutputFormat.setOutputPath(job, new Path(args[1]));
        job.setMapperClass(AppSyncBootMapper.class);
        job.setReducerClass(AppSyncBootReducer.class);
