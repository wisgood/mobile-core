 ...
 * www.funshion.com
 *
 * @Title: FsPlatformActionFormatForDemoForDemo.java 
 * @Package com.bi.dingzi.ver2.format 
 * @Description: 窗帘工具格式化方便其抽取维度表
 * @author fuys
 * @date 2013-8-5 上午11:03:06 
 * @input:输入日志路径/2013-8-5 /dw/logs/tools/origin/FsPlatformAction2/$DIR_DATE
 * @output:输出日志路径/2013-8-5 /dw/logs/tools/result/ver2/FsPlatformAction_Demsion/$DIR_DAY
 * @executeCmd:hadoop jar log_analytics_product.jar com.bi.dingzi.ver2.format.FsPlatformActionFormatForDemo --input $DIR_ORGINDATA_DAY_DTAIL_HOUR_INPUT --output /dw/logs/tools/result/ver2/FsPlatformAction_Demsion/$DIR_DAY --inpulzo 1
...
/**
 * @ClassName: FsPlatformActionFormatForDemoForDemo
 * @Description: 这里用一句话描述这个类的作用
 * @author fuys
 * @date 2013-8-5 上午11:03:06
 */
public class FsPlatformActionFormatForDemo extends Configured implements Tool {
    ...
    public static class FsPlatformActionForDemoMapper extends
        ...
        protected void map(LongWritable key, Text value, Context context)
            ...
            String actionresultStr = fields[FsPlatformActionEnum.ACTIONRESULT
                    .ordinal()];
            String actionobjectverStr = IPFormatUtil
                    .getVersionFormActionObjser("screendll+",
                            fields[FsPlatformActionEnum.ACTIONOBJECTVER
                                    .ordinal()]);

            if (null != actionobjectverStr) {
    ...
    public static class FsPlatformActionForDemoReducer extends
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(new Configuration(),
                new FsPlatformActionFormatForDemo(),
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf,
                "5_product_dingzi_fsplatformactionformatfordemo");
        job.setJarByClass(FsPlatformActionFormatForDemo.class);
        FileInputFormat.setInputPaths(job, args[0]);
        FileOutputFormat.setOutputPath(job, new Path(args[1]));
        job.setMapperClass(FsPlatformActionForDemoMapper.class);
        job.setReducerClass(FsPlatformActionForDemoReducer.class);
