package com.bi.minisite.dimension;
...
{
	private static Logger logger = Logger.getLogger(DimIPTableDAO.class.getName());
		...
		try
		{
			...
			while ((line = in.readLine()) != null)
			{
				...
				catch (Exception e)
				{
					...
					logger.error("ip_table record format error: " + e.getMessage(), e.getCause());
					continue;
				}
			}
		}
