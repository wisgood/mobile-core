...
import com.bi.common.etl.util.DMURLRuleArrayList;

public class DMURLRuleDAOImpl<E, T> extends AbstractDMDAO<E, T> {

	private static Logger logger = Logger.getLogger(DMURLRuleDAOImpl.class
			.getName());
	...
	public T getDMOjb(E param) throws Exception {
		...
		if (null == dmURLRule) {
			...
			urlRuleMap.put(ConstantEnum.URL_SECOND_ID, "1030");
			urlRuleMap.put(ConstantEnum.URL_THIRD_ID, "1199");
		} else {
