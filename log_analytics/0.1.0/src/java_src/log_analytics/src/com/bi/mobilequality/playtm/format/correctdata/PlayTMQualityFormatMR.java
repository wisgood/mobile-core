...
import com.bi.mobilequality.playtm.format.dataenum.PlayTMQualityFormatEnum;
 ...
 * @date 2013-5-10 上午11:25:05
 */
public class PlayTMQualityFormatMR {

    public static class PlayTMQualityFormatMap extends
        ...
        private static Logger logger = Logger
                .getLogger(PlayTMQualityFormatMap.class.getName());
        ...
        public String getPlayTMQualityFormatStr(String originalData) {
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            String playTMETLStr = this.getPlayTMQualityFormatStr(line);
            if (null != playTMETLStr && !("".equalsIgnoreCase(playTMETLStr))) {
                context.write(
                        new Text(
                                playTMETLStr.split("\t")[PlayTMQualityFormatEnum.TIMESTAMP
                                        .ordinal()]), new Text(playTMETLStr));
            }
        }
    }

    public static class PlayTMQualityFormatReduce extends
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJobName("PlayTMQualityFormat");
        ...
        FileOutputFormat.setOutputPath(job, new Path("output_playtm_quality"));
