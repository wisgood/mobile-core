...
public enum PlayTMFormatEnum {
	 ...
	 */
	DATE_ID,HOUR_ID,PLAT_ID,VERSION_ID,QUDAO_ID,CHANNEL_ID,CITY_ID,MACCLEAN,MEDIA_ID,SERIAL_ID,PROVINCE_ID,ISP_ID,TIMESTAMP, IP, DEV, MAC, VER, NT, IH, SPOS, EPOS, VTM, SID, PN,TU,PTYPE,PBRE,RT,IPHONEIP,CL;
}
