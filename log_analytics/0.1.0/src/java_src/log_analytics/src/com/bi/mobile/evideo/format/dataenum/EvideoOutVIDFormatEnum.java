...
public enum EvideoOutVIDFormatEnum {
	/**
	 ...
	 */
	DATE_ID, HOUR_ID, FLAG_ID, PLAT_ID, VERSION_ID, QUDAO_ID, CITY_ID, MAC_CODE, PROVINCE_ID, ISP_ID,TIMESTAMP, IP, DEV, MAC, VER, NT, TYPE, VIDEOID, SID, PTYPE, RT, IPHONEIP, CL;
