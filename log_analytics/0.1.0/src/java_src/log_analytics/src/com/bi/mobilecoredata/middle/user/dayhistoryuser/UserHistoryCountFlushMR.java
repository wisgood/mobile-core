...
public class UserHistoryCountFlushMR {
		...
		public void map(LongWritable key, Text value, Context context)
			...
			try {
				...
				// 新版本的mac地址
					...
					String mac = field[UserCountInfoEnum.MAC.ordinal()]
							.toUpperCase();
	...
	public static void main(String[] args) throws Exception,
		...
		job.setJarByClass(UserHistoryCountFlushMR.class);
		...
		FileOutputFormat.setOutputPath(job, new Path("output_history_user_b"));
