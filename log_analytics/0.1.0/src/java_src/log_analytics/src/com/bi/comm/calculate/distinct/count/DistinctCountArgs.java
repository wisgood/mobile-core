...
public class DistinctCountArgs implements CLPInterface {
	...
	public void init(String jarName) throws Exception {
		...
		CmdLineParser.Option column = parser.addHelp(
				parser.addStringOption('c',"column"), "the given column,e.g 1,2,3");
