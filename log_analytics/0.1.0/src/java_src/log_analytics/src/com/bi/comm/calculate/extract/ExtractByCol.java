...
import com.bi.comm.calculate.extract.ExtractByColMRUTL.ExtractMapper;
import com.bi.comm.calculate.extract.ExtractByColMRUTL.ExtractReduce;
...
public class ExtractByCol extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "ExtractByCol");
