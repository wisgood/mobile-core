...
public class FbufferConditionArgs implements CLPInterface {
	private String[] fbufferConditionParam = null;
	...
	public void parse(String[] args) throws Exception {
		...
		fbufferConditionParam = new String[2];
		fbufferConditionParam[0] = (String) parser.getOptionValue(hashmap.get("input"));
		fbufferConditionParam[1] = (String) parser.getOptionValue(hashmap.get("output"));
	
		if (fbufferConditionParam[0] == null || fbufferConditionParam[1] == null) {
			throw new Exception("the argument value is null");
		}
	}

	public String[] getFufferConditionParam() {
		return fbufferConditionParam;
	}
