...
public class UserNewCountFlushArgs implements CLPInterface {

	private String[] userNewCountFlushParam = null;
	...
	public void parse(String[] args) throws Exception {
		...
		userNewCountFlushParam = new String[2];
		userNewCountFlushParam[0] = (String) parser.getOptionValue(hashmap.get("input"));
		userNewCountFlushParam[1] = (String) parser.getOptionValue(hashmap.get("output"));
		if (userNewCountFlushParam[0] == null || userNewCountFlushParam[1] == null) {
			throw new Exception("the argument value is null");
		}
	}

	public String[] getUserNewOrOldCountFlushParam() {
		return userNewCountFlushParam;
	}
