...
public enum PlayBufferingFormatEnum {
    /**
     * DATE_ID,日期ID
     * HOUR_ID,小时ID
     * VERSION_ID,版本ID
    ...
    DATE_ID, HOUR_ID, VERSION_ID, PROVINCE_ID, CITY_ID, ISP_ID, MAC_FORMAT, PRN_FORMAT, SDN_FORMAT, OK_FORMAT, BT_FORMAT,
    SID, CLIENTIP, TIMESTAMP, PGID, PRN, PVS, BT, IH, MAC, NT, OK, SDN, TT, APCT, BTLT, FRCT, TPCT, VV, PROVINCE, CITY, ISP;
}