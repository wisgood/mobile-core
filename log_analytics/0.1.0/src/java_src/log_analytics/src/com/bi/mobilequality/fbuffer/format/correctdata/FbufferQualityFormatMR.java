...
public class FbufferQualityFormatMR {
    ...
    public static class FbufferQualityFormatMapper extends
        ...
        protected void setup(Context context) throws IOException,
            ...
            if (isLocalRunMode(context)) {
                ...
                dmPlatyRuleDAO.parseDMObj(new File(ConstantEnum.DM_MOBILE_PLATY
                        .name().toLowerCase()));
                // dmQuDaoRuleDAO.parseDMObj(new
                // File(ConstantEnum.DM_MOBILE_QUDAO
                // .name().toLowerCase()));
        ...
        private String logFormat(String originLog) {
            ...
            try {
                ...
                if (platOrigin.contains("flash")
                        || platOrigin.contains("winphone"))
                    return empty;
                ...
                formatLog.append("\t");
                for (String originField : fields) {
                    formatLog.append(originField);
                    formatLog.append("\t");
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            if (null != formatLog && !("".equalsIgnoreCase(formatLog))) {
                context.write(
                        new Text(
                                formatLog.split("\t")[FbufferQualityFormatEnum.DATA_ID
    ...
    public static class FbufferQualityFormatReducer extends
    ...
    public static void main(String[] args) throws IOException,
        ...
        FileOutputFormat.setOutputPath(job, new Path("output_fbuffer"));
