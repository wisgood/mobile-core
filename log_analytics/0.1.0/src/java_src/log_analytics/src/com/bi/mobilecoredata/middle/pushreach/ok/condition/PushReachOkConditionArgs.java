...
public class PushReachOkConditionArgs implements CLPInterface{
    ...
    public void init(String jarName) throws Exception {
        ...
        CmdLineParser.Option ok = parser.addHelp(
                parser.addStringOption('k', "ok"),
                "the given ok,e.g 1,2,3");
        hashmap.put("ok", ok);
    }
    ...
    public void parse(String[] args) throws Exception {
        ...
        okParam[0] = (String) parser.getOptionValue(hashmap
                .get("input"));
        okParam[1] = (String) parser.getOptionValue(hashmap
                .get("output"));
        okParam[2] = (String) parser.getOptionValue(hashmap
                .get("ok"));
        if (okParam[0] == null || okParam[1] == null
                || okParam[2] == null) {
