...
public class SumSingleArgs implements CLPInterface {
	...
	public void init(String jarName) throws Exception{
		...
		CmdLineParser.Option sumcol = parser.addHelp(
				parser.addStringOption('c',"sumcol"), "the given sum column,e.g 1");
	...
	public  void parse(String[] args) throws Exception{
		...
		sumParam = new String[3];
		sumParam[0] = (String) parser.getOptionValue(hashmap.get("input"));
		sumParam[1] = (String) parser.getOptionValue(hashmap.get("output"));
		sumParam[2] = (String) parser.getOptionValue(hashmap.get("sumcol"));

		if (sumParam[0] == null || sumParam[1] == null || sumParam[2] == null ) {			
