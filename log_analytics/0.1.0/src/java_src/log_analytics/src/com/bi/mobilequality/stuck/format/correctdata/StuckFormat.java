...
import com.bi.mobilequality.stuck.format.correctdata.StuckFormatMR.StuckFormatMap;
import com.bi.mobilequality.stuck.format.correctdata.StuckFormatMR.StuckFormatReduce;
...
public class StuckFormat extends Configured implements Tool
{
	...
	public int run(String[] args) throws Exception
	{
		...
		Job job = new Job(conf, "StuckFormatMR");
	...
	public static void main(String[] args) throws Exception
	{
		...
		nRet = ToolRunner.run(new Configuration(), new StuckFormat(), logArgs.getParamStrs());
