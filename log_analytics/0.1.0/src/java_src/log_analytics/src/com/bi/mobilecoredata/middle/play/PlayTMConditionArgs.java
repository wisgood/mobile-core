...
public class PlayTMConditionArgs implements CLPInterface {
	private String[] playTMConditionParam = null;
	...
	public void parse(String[] args) throws Exception {
		...
		playTMConditionParam = new String[2];
		playTMConditionParam[0] = (String) parser.getOptionValue(hashmap.get("input"));
		playTMConditionParam[1] = (String) parser.getOptionValue(hashmap.get("output"));
	
		if (playTMConditionParam[0] == null || playTMConditionParam[1] == null) {
			throw new Exception("the argument value is null");
		}
	}

	public String[] getPlayTMConditionParam() {
		return playTMConditionParam;
	}
