...
public class UserNewActiveListArgs implements CLPInterface {

	private String[] userNewActiveCountParam = null;
	...
	public void parse(String[] args) throws Exception {
		...
		userNewActiveCountParam = new String[2];
		userNewActiveCountParam[0] = (String) parser.getOptionValue(hashmap
				.get("input"));
		userNewActiveCountParam[1] = (String) parser.getOptionValue(hashmap
				.get("output"));
		if (userNewActiveCountParam[0] == null
				|| userNewActiveCountParam[1] == null) {
			throw new Exception("the argument value is null");
		}
	}

	public String[] getUserNewActiveCountParam() {
		return userNewActiveCountParam;
	}
