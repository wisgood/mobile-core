...
public enum PlayEnum {
	...
	3    timestamp: 日志记录时间
    4    ip: 用户IP地址
    5    client_flg: 新增上报 用来区分客户端和WEB,2013-11-23新增
    5    fck: 时间戳+随机数
    6    mac: 用户Mac地址
	...
	PROTOCOL, RPROTOCOL, TIMESTAMP, IP, CLIENT_FLAG, FCK, MAC, USERID, FPC, VERSION, SESSION_ID, 
	PVID, CONFIG, URL, REFERURL, ISP_ID, MEDIATYPE, TARGET, HASHID, VVID, LIAN,
