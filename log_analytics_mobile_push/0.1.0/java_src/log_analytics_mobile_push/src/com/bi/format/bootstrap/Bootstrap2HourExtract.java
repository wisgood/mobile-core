...
/**
 * 
 * @ClassName: Bootstrap2HourExtract
 * @Description: 这里用一句话描述这个类的作用
 * @author wang
 * @date 2013-10-10 下午8:25:55
 */
public class Bootstrap2HourExtract extends Configured implements Tool {

    public static class Bootstrap2HourExtractMapper extends
    ...
    public static void main(String[] args) throws Exception {
        ...
        nRet = ToolRunner.run(new Configuration(), new Bootstrap2HourExtract(),
    ...
    public int run(String[] args) throws Exception {
        ...
        conf.set("mid", args[2]);
        Job job = new Job(conf, "pushreach-bootstrap-2hour-extract");
        job.setJarByClass(Bootstrap2HourExtract.class);
        HdfsUtil.deleteDir(args[1]);
        FileInputFormat.addInputPath(job, new Path(args[0]));
        FileOutputFormat.setOutputPath(job, new Path(args[1]));
        job.setMapperClass(Bootstrap2HourExtractMapper.class);
