...
public class Fbuffer2HourExtract extends Configured implements Tool {

    public static class Fbuffer2HourExtractMapper extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            long timestamp = Long.parseLong(fields[FormatFbufferEnum.TIMESTAMP
                    .ordinal()]);
    ...
    public static void main(String[] args) throws Exception {
        ...
        nRet = ToolRunner.run(new Configuration(), new Fbuffer2HourExtract(),
    ...
    public int run(String[] args) throws Exception {
        ...
        conf.set("mid", args[2]);
        Job job = new Job(conf, "pushreach-fbuffer-2hour-extract");
        job.setJarByClass(Fbuffer2HourExtract.class);
        HdfsUtil.deleteDir(args[1]);
        FileInputFormat.addInputPath(job, new Path(args[0]));
        FileOutputFormat.setOutputPath(job, new Path(args[1]));
        job.setMapperClass(Fbuffer2HourExtractMapper.class);
