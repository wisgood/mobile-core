 ...
 */
public class AndriodPushBoot1HourWatchMac extends Configured implements Tool {

    private static char SEPERATOR = '\t';

    public static class AndriodPushBoot1HourWatchMacMapper extends
    ...
    public static class AndriodPushBoot1HourWatchMacReducer extends
    ...
    public static void main(String[] args) throws Exception {
        ...
        nRet = ToolRunner.run(new Configuration(),
                new AndriodPushBoot1HourWatchMac(), paramParse.getParams());
    ...
    public int run(String[] args) throws Exception {
        ...
        conf.set("mid", args[2]);
        Job job = new Job(conf, "andriod-pushboot-1hour-watch-mac");
        job.setJarByClass(AndriodPushBoot1HourWatchMac.class);
        FileInputFormat.addInputPaths(job, args[0]);
        HdfsUtil.deleteDir(args[1]);
        FileOutputFormat.setOutputPath(job, new Path(args[1]));
        job.setMapperClass(AndriodPushBoot1HourWatchMacMapper.class);
        job.setReducerClass(AndriodPushBoot1HourWatchMacReducer.class);
