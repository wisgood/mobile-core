 ...
 * www.funshion.com
 *
* @Title: DayWtbhUserDateProvince.java 
...
* @output: f_client_day_wtbh_user_date_province:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayWtbhUserDateProvince \
*                    /dw/logs/client/format/hs_log//2013/08/01 \
*                    /dw/logs/client/format/wtbh/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_wtbh_user_date_province/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayWtbhUserDateProvince extends Configured implements Tool {
...
//DayWtbhUserDateProvince get the effective install user list 
    public static class DayWtbhUserDateProvinceMapper extends
    ...
    public static class DayWtbhUserDateProvinceReducer extends
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayWtbhUserDateProvince(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayWtbhUserDateProvince");
        job.setJarByClass(DayWtbhUserDateProvince.class);
        ...
        job.setMapperClass(DayWtbhUserDateProvinceMapper.class);
        job.setReducerClass(DayWtbhUserDateProvinceReducer.class);
