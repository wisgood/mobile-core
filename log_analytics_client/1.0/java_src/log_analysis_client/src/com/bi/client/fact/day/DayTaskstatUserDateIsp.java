...
* @output: f_client_day_taskstat_user_date_isp:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayTaskstatUserDateIsp \
*                    /dw/logs/client/format/taskstat/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_taskstat_user_date_isp/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayTaskstatUserDateIsp extends Configured implements Tool {
...
//DayTaskstatUserDateIsp get the effective install user list 
    public static class DayTaskstatUserDateIspMapper extends
    ...
    public static class DayTaskstatUserDateIspReducer extends
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayTaskstatUserDateIsp(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayTaskstatUserDateIsp");
        job.setJarByClass(DayTaskstatUserDateIsp.class);
        ...
        job.setMapperClass(DayTaskstatUserDateIspMapper.class);
        job.setReducerClass(DayTaskstatUserDateIspReducer.class);
