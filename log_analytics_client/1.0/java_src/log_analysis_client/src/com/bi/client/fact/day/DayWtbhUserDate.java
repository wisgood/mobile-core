...
* @output: f_client_day_wtbh_user_date:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayWtbhUserDate \
*                    /dw/logs/client/format/hs_log//2013/08/01 \
*                    /dw/logs/client/format/wtbh/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_wtbh_user_date/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayWtbhUserDate extends Configured implements Tool {
...
//DayWtbhUserDate get the effective install user list 
    public static class DayWtbhUserDateMapper extends
    ...
    public static class DayWtbhUserDateReducer extends
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayWtbhUserDate");
        job.setJarByClass(DayWtbhUserDate.class);
        ...
        job.setMapperClass(DayWtbhUserDateMapper.class);
        job.setReducerClass(DayWtbhUserDateReducer.class);
