...
* @output: f_client_day_boot_user_date_isp:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayBootUserDateIsp \
*                    /dw/logs/client/format/boot/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_boot_user_date_isp/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayBootUserDateIsp extends Configured implements Tool {
   // private static final String SEPARATOR = "\t";
    ...
    public static class DayBootUserDateIspMapper extends
    ...
    public static class DayBootUserDateIspReducer extends
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayBootUserDateIsp");
        job.setJarByClass(DayBootUserDateIsp.class);
       
        
        FileInputFormat.addInputPath(job, new Path(args[0]));
        FileOutputFormat.setOutputPath(job, new Path(args[1]));
        FileSystem.get(conf).delete(new Path(args[1]), true); 
        job.setMapperClass(DayBootUserDateIspMapper.class);
        job.setReducerClass(DayBootUserDateIspReducer.class);
