...
public class BootLogFormatMR extends Configured implements Tool {

	public static class BootLogFormatMapper extends
		...
		public void map(LongWritable key, Text value, Context context)
			...
			try {				
				...
				BootLog bootLog = new BootLog(fields.length); 
				bootLog.setIpParser(ipParser);
				bootLog.setStatDate(statDate);
				bootLog.setFileds(fields);
				newValue.set(bootLog.toString());
	...
	public static class BootLogFormatReducer extends 
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(BootLogFormatMR.class);
		job.setMapperClass(BootLogFormatMapper.class);	
		//job.setReducerClass(BootLogFormatReducer.class);
...
//	    lzoIndexer.index(new Path(conf.get("output_dir")));
	...
	public static void main(String[] args) throws Exception {
		int nRet = ToolRunner
				.run(new Configuration(), new BootLogFormatMR(), args);
