...
* @output: f_client_day_boot_user_date_province:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayBootUserDateProvince \
*                    /dw/logs/client/format/boot/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_boot_user_date_province/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayBootUserDateProvince extends Configured implements Tool {
   // private static final String SEPARATOR = "\t";
    ...
    public static class DayBootUserDateProvinceMapper extends
    ...
    public static class DayBootUserDateProvinceReducer extends
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayBootUserDateProvince(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayBootUserDateProvince");
        job.setJarByClass(DayBootUserDateProvince.class);
        ...
        job.setMapperClass(DayBootUserDateProvinceMapper.class);
        job.setReducerClass(DayBootUserDateProvinceReducer.class);
