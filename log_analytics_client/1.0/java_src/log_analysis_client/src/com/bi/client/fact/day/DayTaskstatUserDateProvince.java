...
* @output: f_client_day_taskstat_user_date_province:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayTaskstatUserDateProvince \
*                    /dw/logs/client/format/taskstat/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_taskstat_user_date_province/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayTaskstatUserDateProvince extends Configured implements Tool {
...
//DayTaskstatUserDateProvince get the effective install user list 
    public static class DayTaskstatUserDateProvinceMapper extends
    ...
    public static class DayTaskstatUserDateProvinceReducer extends
		...
		protected void reduce(Text key, Iterable<Text> values, Context context)
			...
			Set<String> taskstatmacSet=new HashSet<String>();
		    	...
		    	if (!onlineuserInteger.equals(0))
		     	{
		     	    UIAverageOnlinelength=UIOnlinelength*3*60/onlineuserInteger;
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayTaskstatUserDateProvince(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayTaskstatUserDateProvince");
        job.setJarByClass(DayTaskstatUserDateProvince.class);
        ...
        job.setMapperClass(DayTaskstatUserDateProvinceMapper.class);
        job.setReducerClass(DayTaskstatUserDateProvinceReducer.class);
