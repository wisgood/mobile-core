 ...
 * www.funshion.com
 *
* @Title: DayInstallUserDateVersion.java 
...
* @output: f_client_day_instl_user_date_version:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayInstallUserDateVersion \
*                    /dw/logs/client/format/install/2013/08/01 \
*                    /dw/logs/client/format/hs_log//2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_instl_user_date_version/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayInstallUserDateVersion extends Configured implements Tool {
...
//DayInstallUserDateVersion get the effective install user list 
    public static class DayInstallUserDateVersionMapper extends
       ...
       private Path path;
        ...
        public void map(LongWritable key, Text value, Context context)
        	...
        	{
        	strKey.append(strTemp[3]+"\t"+strTemp[0]+"\t"+strTemp[1]);
    ...
    public static class DayInstallUserDateVersionReducer extends
    ...
    public static class DayInstallUserDateVersionResultMapper extends
            Mapper<LongWritable, Text, Text, Text> {
    ...
    public static class DayInstallUserDateVersionResultReducer extends
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayInstallUserDateVersion(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayInstallUserDateVersion");
        job.setJarByClass(DayInstallUserDateVersion.class);
        ...
        job.setMapperClass(DayInstallUserDateVersionMapper.class);
        job.setReducerClass(DayInstallUserDateVersionReducer.class);
        ...
        if(code==0)
        {
        	Job resultJob=new Job(conf, "DayInstallUserDateVersionResult");
        	
        	resultJob.setJarByClass(DayInstallUserDateVersion.class);
        	...
        	resultJob.setMapperClass(DayInstallUserDateVersionResultMapper.class);
        	resultJob.setReducerClass(DayInstallUserDateVersionResultReducer.class);
