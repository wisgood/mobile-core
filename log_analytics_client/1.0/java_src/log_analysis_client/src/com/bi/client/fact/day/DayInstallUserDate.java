...
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayInstallUserDate \
...
public class DayInstallUserDate extends Configured implements Tool {
...
//DayInstallUserDate get the effective install user list 
    public static class DayInstallUserDateMapper extends
       ...
       private Path path;
        ...
        public void map(LongWritable key, Text value, Context context)
        	...
        	{
        	strKey.append(strTemp[3]+"\t"+strTemp[0]);
    ...
    public static class DayInstallUserDateReducer extends
		...
		protected void reduce(Text key, Iterable<Text> values, Context context)
			...
			strKeyString=key.toString().split("\t");
		       ...
		       Set<String> vHS = new HashSet<String>();
		    	...
		    	{
		     		context.write(new Text(strKeyString[1]), new Text(strKeyString[0]));
		    	}
    ...
    public static class DayInstallUserDateResultMapper extends
            Mapper<LongWritable, Text, Text, Text> {
    ...
    public static class DayInstallUserDateResultReducer extends
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayInstallUserDate");
        job.setJarByClass(DayInstallUserDate.class);
        ...
        job.setMapperClass(DayInstallUserDateMapper.class);
        job.setReducerClass(DayInstallUserDateReducer.class);
        ...
        if(code==0)
        {
        	Job resultJob=new Job(conf, "DayInstallUserDateResult");
        	
        	resultJob.setJarByClass(DayInstallUserDate.class);
        	...
        	resultJob.setMapperClass(DayInstallUserDateResultMapper.class);
        	resultJob.setReducerClass(DayInstallUserDateResultReducer.class);
