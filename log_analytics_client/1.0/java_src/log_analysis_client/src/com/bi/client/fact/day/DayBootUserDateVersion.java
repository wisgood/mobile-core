...
* @output: f_client_day_boot_user_date_version:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayBootUserDateVersion \
*                    /dw/logs/client/format/boot/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_boot_user_date_version/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayBootUserDateVersion extends Configured implements Tool {
   // private static final String SEPARATOR = "\t";
    ...
    public static class DayBootUserDateVersionMapper extends
    ...
    public static class DayBootUserDateVersionReducer extends
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayBootUserDateVersion(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayBootUserDateVersion");
        job.setJarByClass(DayBootUserDateVersion.class);
        ...
        job.setMapperClass(DayBootUserDateVersionMapper.class);
        job.setReducerClass(DayBootUserDateVersionReducer.class);
