...
* @output: f_client_day_online_user_date_province:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayhslogUserDateProvince \
*                    /dw/logs/client/format/hs_log/2013/08/01 \
*                    /dw/logs/3_client/2_user/1_history_mac/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_online_user_date_province/2013/08/01
* @inputFormat:...
* @ouputFormat:...
*/
...
public class DayhslogUserDateProvince extends Configured implements Tool {
...
//DayhslogUserDateProvince get the effective install user list 
    public static class DayhslogUserDateProvinceMapper extends
    ...
    public static class DayhslogUserDateProvinceReducer extends
    ...
    public static class DayhslogUserDateProvinceNewMacMapper extends
    Mapper<LongWritable, Text, Text, Text> {
...
public void map(LongWritable key, Text value, Context context)
	...
	String [] strTemp= value.toString().split("\t");
		...
		if(path.toString().contains("hs_log"))
    	{
				...
				context.write(new Text(strTemp[3]), new Text("1"+"\t"+strTemp[0]+"\t"+strTemp[2]));
    ...
    public static class DayhslogUserDateProvinceNewMacReducer extends
...
protected void reduce(Text key, Iterable<Text> values, Context context)
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayhslogUserDateProvince(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        // TODO Auto-generated method stub
       // String dateString="20130801";
    	
    	Configuration conf = getConf();
    	//conf.set("stat_date", dateString);
    	
        Job job = new Job(conf, "DayhslogUserDateProvinceNewMac");
        job.setJarByClass(DayhslogUserDateProvince.class);
        ...
        job.setMapperClass(DayhslogUserDateProvinceNewMacMapper.class);
        job.setReducerClass(DayhslogUserDateProvinceNewMacReducer.class);
       ...
       // job.setInputFormatClass(LzoTextInputFormat.class);
        ...
        if(code==0)
        {
        	Job resultJob=new Job(conf, "DayhslogUserDateProvince");
        	
        	resultJob.setJarByClass(DayhslogUserDateProvince.class);
        	...
        	resultJob.setMapperClass(DayhslogUserDateProvinceMapper.class);
        	resultJob.setReducerClass(DayhslogUserDateProvinceReducer.class);
