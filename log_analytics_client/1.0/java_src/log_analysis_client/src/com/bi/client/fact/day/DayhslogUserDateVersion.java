...
* @output: f_client_day_online_user_date_version:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayhslogUserDateVersion \
*                    /dw/logs/client/format/hs_log/2013/08/01 \
*                    /dw/logs/3_client/2_user/1_history_mac/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_online_user_date_version/2013/08/01
* @inputFormat:...
* @ouputFormat:...
*/
...
public class DayhslogUserDateVersion extends Configured implements Tool {
...
//DayhslogUserDateVersion get the effective install user list 
    public static class DayhslogUserDateVersionMapper extends
    ...
    public static class DayhslogUserDateVersionReducer extends
    ...
    public static class DayhslogUserDateVersionNewMacMapper extends
    Mapper<LongWritable, Text, Text, Text> {
...
public void map(LongWritable key, Text value, Context context)
	...
	String [] strTemp= value.toString().split("\t");
		...
		if(path.toString().contains("hs_log"))
    	{
				...
				context.write(new Text(strTemp[3]), new Text("1"+"\t"+strTemp[0]+"\t"+strTemp[1]));
    ...
    public static class DayhslogUserDateVersionNewMacReducer extends
...
protected void reduce(Text key, Iterable<Text> values, Context context)
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayhslogUserDateVersion(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayhslogUserDateVersionNewMac");
        job.setJarByClass(DayhslogUserDateVersion.class);
        ...
        job.setMapperClass(DayhslogUserDateVersionNewMacMapper.class);
        job.setReducerClass(DayhslogUserDateVersionNewMacReducer.class);
       ...
       // job.setInputFormatClass(LzoTextInputFormat.class);
        ...
        if(code==0)
        {
        	Job resultJob=new Job(conf, "DayhslogUserDateVersion");
        	
        	resultJob.setJarByClass(DayhslogUserDateVersion.class);
        	...
        	resultJob.setMapperClass(DayhslogUserDateVersionMapper.class);
        	resultJob.setReducerClass(DayhslogUserDateVersionReducer.class);
