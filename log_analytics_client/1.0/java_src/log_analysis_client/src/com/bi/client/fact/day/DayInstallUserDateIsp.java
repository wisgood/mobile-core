 ...
 * www.funshion.com
 *
* @Title: DayInstallUserDateIsp.java 
...
* @output: f_client_day_instl_user_date_isp:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayInstallUserDateIsp \
*                    /dw/logs/client/format/install/2013/08/01 \
*                    /dw/logs/client/format/hs_log//2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_instl_user_date_isp/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayInstallUserDateIsp extends Configured implements Tool {
...
//DayInstallUserDateIsp get the effective install user list 
    public static class DayInstallUserDateIspMapper extends
       ...
       private Path path;
        ...
        public void map(LongWritable key, Text value, Context context)
        	...
        	{
        	strKey.append(strTemp[3]+"\t"+strTemp[0]+"\t"+strTemp[4]);
    ...
    public static class DayInstallUserDateIspReducer extends
    ...
    public static class DayInstallUserDateIspResultMapper extends
            Mapper<LongWritable, Text, Text, Text> {
       ...
       private Path path;
        ...
        public void map(LongWritable key, Text value, Context context)
        	...
        	if(path.toString().contains("install"))
        	{
        	strKey.append(strTemp[0]+"\t"+strTemp[4]);
    ...
    public static class DayInstallUserDateIspResultReducer extends
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayInstallUserDateIsp(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayInstallUserDateIsp");
        job.setJarByClass(DayInstallUserDateIsp.class);
        ...
        job.setMapperClass(DayInstallUserDateIspMapper.class);
        job.setReducerClass(DayInstallUserDateIspReducer.class);
        ...
        if(code==0)
        {
        	Job resultJob=new Job(conf, "DayInstallUserDateIspResult");
        	
        	resultJob.setJarByClass(DayInstallUserDateIsp.class);
        	...
        	resultJob.setMapperClass(DayInstallUserDateIspResultMapper.class);
        	resultJob.setReducerClass(DayInstallUserDateIspResultReducer.class);
