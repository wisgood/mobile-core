...
* @output: f_client_day_online_user_date:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayhslogUserDate \
*                    /dw/logs/client/format/hs_log/2013/08/01 \
*                    /dw/logs/3_client/2_user/1_history_mac/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_online_user_date/2013/08/01
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayhslogUserDate extends Configured implements Tool {
...
//DayhslogUserDate get the effective install user list 
    public static class DayhslogUserDateMapper extends
        ...
        if(path.toString().contains("hs_log"))
        	{
    		 ...
    		 endflow=strTemp[19];
    			...
    			strValue.append("\t");
    			strValue.append("-");
        		context.write(new Text(strTemp[0]), new Text(strValue.toString()));
    ...
    public static class DayhslogUserDateReducer extends
    ...
    public static class DayhslogUserDateNewMacMapper extends
    Mapper<LongWritable, Text, Text, Text> {
...
public void map(LongWritable key, Text value, Context context)
    ...
    public static class DayhslogUserDateNewMacReducer extends
