...
* @output: f_client_day_taskstat_user_date_version:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayTaskstatUserDateVersion \
*                    /dw/logs/client/format/taskstat/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_taskstat_user_date_version/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayTaskstatUserDateVersion extends Configured implements Tool {
...
//DayTaskstatUserDateVersion get the effective install user list 
    public static class DayTaskstatUserDateVersionMapper extends
    ...
    public static class DayTaskstatUserDateVersionReducer extends
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res = ToolRunner.run(new Configuration(),
				new DayTaskstatUserDateVersion(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayTaskstatUserDateVersion");
        job.setJarByClass(DayTaskstatUserDateVersion.class);
        ...
        job.setMapperClass(DayTaskstatUserDateVersionMapper.class);
        job.setReducerClass(DayTaskstatUserDateVersionReducer.class);
