...
* @output: f_client_day_wtbh_user_date_isp:  /dw/logs/3_client/2_user/2_day/
* @executeCmd:hadoop jar UserDay.jar  com.bi.client.user.day.DayWtbhUserDateIsp \
*                    /dw/logs/client/format/hs_log//2013/08/01 \
*                    /dw/logs/client/format/wtbh/2013/08/01 \
*                    /dw/logs/3_client/2_user/2_day/f_client_day_wtbh_user_date_isp/2013/08/01 \
* @inputFormat:text
* @ouputFormat:text
*/
...
public class DayWtbhUserDateIsp extends Configured implements Tool {
...
//DayWtbhUserDateIsp get the effective install user list 
    public static class DayWtbhUserDateIspMapper extends
    ...
    public static class DayWtbhUserDateIspReducer extends
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "DayWtbhUserDateIsp");
        job.setJarByClass(DayWtbhUserDateIsp.class);
        ...
        job.setMapperClass(DayWtbhUserDateIspMapper.class);
        job.setReducerClass(DayWtbhUserDateIspReducer.class);
