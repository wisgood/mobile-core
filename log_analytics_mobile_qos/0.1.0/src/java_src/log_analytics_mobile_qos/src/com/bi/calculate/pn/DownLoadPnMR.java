 ...
 * www.funshion.com
 *
 * @Title: DownLoadPnMR.java 
 * @Package com.bi.calculate.pn 
 * @Description: 对日志名进行处理
 * @author fuys
 * @date 2013-9-7 上午11:51:28 
...
/**
 * @ClassName: DownLoadPnMR
 * @Description: 这里用一句话描述这个类的作用
 * @author fuys
 * @date 2013-9-7 上午11:51:28
 */
public class DownLoadPnMR extends Configured implements Tool {

    public static class DownLoadPnMapper extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            long drateFormat = 0l;
            try {
                drateFormat = DataFormatUtils.parseDoubleToLong(field,
                        FormatFbufferEnum.class.getName(),
                        FormatFbufferEnum.DRATE_FORMAT.toString());
            }
            catch(Exception e) {
                drateFormat = 0l;
            ...
            for (int i = 0; i < outKeyList.size(); i++) {
                context.write(new Text(outKeyList.get(i)), new LongWritable(
                        drateFormat));
            }
    ...
    public static class DownLoadPnReducer extends
    ...
    public static void main(String[] args) throws Exception {
        // TODO Auto-generated method stub
        int res = ToolRunner.run(new Configuration(), new DownLoadPnMR(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(DownLoadPnMR.class);
        System.out.println("groupby:" + job.getConfiguration().get("groupby"));
        job.setMapperClass(DownLoadPnMapper.class);
        // Text, LongWritable
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(LongWritable.class);
        job.setReducerClass(DownLoadPnReducer.class);
        ...
        job.setJobName("mobilequality_downloadPn_" + executeDateStr);
