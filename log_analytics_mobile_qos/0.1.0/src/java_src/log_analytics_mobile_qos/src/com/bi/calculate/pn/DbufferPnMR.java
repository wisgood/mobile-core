 ...
 * www.funshion.com
 *
 * @Title: DbufferPn.java 
 * @Package com.bi.calculate.pn 
 * @Description: 对日志名进行处理
 * @author fuys
 * @date 2013-9-7 上午11:05:10 
...
import com.bi.common.logenum.FormatDbufferEnum;
 ...
 * @date 2013-9-7 上午11:05:10
 */
public class DbufferPnMR extends Configured implements Tool {

    public static class DbufferPnMapper extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            try {
                ...
                int ok = Integer
                        .parseInt(field[FormatDbufferEnum.OK.ordinal()]);
                double btmDouble = 0;

                btmDouble = Double
                        .parseDouble(field[FormatDbufferEnum.BTM_FORMAT
                                .ordinal()]);
    ...
    public static class DbufferPnReducer extends
    ...
    public static void main(String[] args) throws Exception {
        // TODO Auto-generated method stub
        int res = ToolRunner.run(new Configuration(), new DbufferPnMR(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(DbufferPnMR.class);
        System.out.println("groupby:" + job.getConfiguration().get("groupby"));
        job.setMapperClass(DbufferPnMapper.class);
        // Text, LongWritable
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(LongWritable.class);
        job.setReducerClass(DbufferPnReducer.class);
