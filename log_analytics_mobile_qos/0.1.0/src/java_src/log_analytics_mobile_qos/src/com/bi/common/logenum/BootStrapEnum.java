 ...
 * www.funshion.com
 *
 * @Title: BootStrapEnum.java 
 * @Package com.bi.common.logenum 
 * @Description: 对日志名进行处理
 * @author fuys
 * @date 2013-8-29 下午4:28:58 
...
public enum BootStrapEnum {
     ...
     * 设备剩余空间(fdisk)：单位MB  渠道ID(sid):区分各个渠道商  启动时间戳（rt）：unix时间戳 (ipad, iphone)
     * 是否越狱（broken）： (iphone)  设备IMEI（imei）: 设备IMEI号 (aphone，apad)
     */
