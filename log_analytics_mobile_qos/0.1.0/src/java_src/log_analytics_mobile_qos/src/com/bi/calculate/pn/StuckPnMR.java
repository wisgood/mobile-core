 ...
 * www.funshion.com
 *
 * @Title: StuckPnMR.java 
 * @Package com.bi.calculate.pn 
 * @Description: 对日志名进行处理
 * @author fuys
 * @date 2013-9-7 下午12:26:04 
...
import com.bi.common.logenum.FormatStuckEnum;
 ...
 * @date 2013-9-7 下午12:26:04
 */
public class StuckPnMR extends Configured implements Tool {

    public static class StuckFailPnMapper extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            try {
                ...
                int ok = Integer.parseInt(field[FormatStuckEnum.BUFFEROK
                        .ordinal()]);
                double btmDouble = 0;

                btmDouble = Double.parseDouble(field[FormatStuckEnum.STUCKTIME
                        .ordinal()]);
    ...
    public static class StuckFailPnReducer extends
    ...
    public static void main(String[] args) throws Exception {
        // TODO Auto-generated method stub
        int res = ToolRunner.run(new Configuration(), new StuckPnMR(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(StuckPnMR.class);
        System.out.println("groupby:" + job.getConfiguration().get("groupby"));
        job.setMapperClass(StuckFailPnMapper.class);
        // Text, LongWritable
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(LongWritable.class);
        job.setReducerClass(StuckFailPnReducer.class);
