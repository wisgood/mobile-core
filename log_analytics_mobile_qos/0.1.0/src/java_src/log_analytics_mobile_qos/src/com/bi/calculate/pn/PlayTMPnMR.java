 ...
 * www.funshion.com
 *
 * @Title: PlayTMPnMR.java 
 * @Package com.bi.calculate.pn 
 * @Description: 对日志名进行处理
 * @author fuys
 * @date 2013-9-7 下午12:23:09 
...
/**
 * @ClassName: PlayTMPnMR
 * @Description: 这里用一句话描述这个类的作用
 * @author fuys
 * @date 2013-9-7 下午12:23:09
 */
public class PlayTMPnMR extends Configured implements Tool {

    public static class PlayTMPnMapper extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            try {
                ...
                double tuDouble = Double
                        .parseDouble(field[FormatPlayTMEnum.TU_FORMAT.ordinal()]);
                for (int i = 0; i < outKeyList.size(); i++) {
                    context.write(new Text(outKeyList.get(i)),
                            new LongWritable((long) tuDouble));
                }
            }
            catch(Exception e) {
    ...
    public static class PlayTMPnReducer extends
    ...
    public static void main(String[] args) throws Exception {
        // TODO Auto-generated method stub
        int res = ToolRunner.run(new Configuration(), new PlayTMPnMR(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(PlayTMPnMR.class);
        System.out.println("groupby:" + job.getConfiguration().get("groupby"));
        job.setMapperClass(PlayTMPnMapper.class);
        // Text, LongWritable
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(LongWritable.class);
        job.setReducerClass(PlayTMPnReducer.class);
        ...
        job.setJobName("mobilequality_PlayTMPn_" + executeDateStr);
