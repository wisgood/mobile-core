 ...
 * 
 */
public class MonitorLogFormatMR extends Configured implements Tool {

	public static class MonitorLogFormatMapper extends
		...
		public void map(LongWritable key, Text value, Context context)
			...
			try {				
				...
				if( MonitorLog.isMonitorLog(logType)){
					MonitorLog.checkLengthEligible(logType, fields.length);
					MonitorLog monitorLog = new MonitorLog();
					monitorLog.setAdInfo(adInfo);
					monitorLog.setAdpInfo(adpInfo);
					monitorLog.setIpArea(ipArea);
					monitorLog.setLiveInfo(liveInfo);
					monitorLog.setMatInfo(matInfo);
					monitorLog.setMediaInfo(mediaInfo);
					monitorLog.setFields(fields);				
					newValue.set(monitorLog.toString());
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MonitorLogFormatMR.class);
		job.setMapperClass(MonitorLogFormatMapper.class);
	...
	public static void main(String[] args) throws Exception {
		int nRet = ToolRunner
				.run(new Configuration(), new MonitorLogFormatMR(), args);
