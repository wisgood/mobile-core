 ...
 * 
 */
public class ClickLogFormatMR extends Configured implements Tool {

	public static class ClickLogFormatMapper extends
		...
		public void map(LongWritable key, Text value, Context context)
			...
			try {				
				...
				if( ClickLog.isClickLog(logType)){
					ClickLog.checkLengthEligible(logType, fields.length);
					ClickLog clickLog = new ClickLog();
					clickLog.setAdInfo(adInfo);
					clickLog.setAdpInfo(adpInfo);
					clickLog.setIpArea(ipArea);
					clickLog.setLiveInfo(liveInfo);
					clickLog.setMediaInfo(mediaInfo);
					clickLog.setFields(fields);				
					newValue.set(clickLog.toString());
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(ClickLogFormatMR.class);
		job.setMapperClass(ClickLogFormatMapper.class);		
	...
	public static void main(String[] args) throws Exception {
		int nRet = ToolRunner
				.run(new Configuration(), new ClickLogFormatMR(), args);
