 ...
 * 
 */
public class CDByColsLlyMR_LE2LE3 extends Configured implements Tool
{

	public static class CDByColsLly_LE2LE3_Mapper extends
	...
	public static class CDByColsLly_LE2LE3_Reducer extends
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_LE2LE3");
		job.setJarByClass(CDByColsLlyMR_LE2LE3.class);
		...
		job.setMapperClass(CDByColsLly_LE2LE3_Mapper.class);
		job.setReducerClass(CDByColsLly_LE2LE3_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		int nRet = 0;
		nRet = ToolRunner.run(new Configuration(), new CDByColsLlyMR_LE2LE3(),
