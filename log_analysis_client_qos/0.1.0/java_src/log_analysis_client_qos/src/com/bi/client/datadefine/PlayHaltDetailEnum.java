...
public enum PlayHaltDetailEnum
{
	...
	{
		PlayHaltDetailEnum[] enumFields = PlayHaltDetailEnum.values();
		Set<String> fieldsSet = new HashSet<String>();
		for (PlayHaltDetailEnum field : enumFields)
		{
	...
	{
		PlayHaltDetailEnum[] enumFields = PlayHaltDetailEnum.values();
		for (PlayHaltDetailEnum singleEnum : enumFields)
		{
		...
		throw new CustomEnumFieldNotFoundException(PlayHaltDetailEnum.class.getName(), fieldName);
	}
