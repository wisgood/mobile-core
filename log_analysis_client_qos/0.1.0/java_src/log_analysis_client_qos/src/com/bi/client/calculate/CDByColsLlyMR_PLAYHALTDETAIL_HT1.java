 ...
 * 
 */
public class CDByColsLlyMR_PLAYHALTDETAIL_HT1 extends Configured implements Tool
{

	public static class CDByColsLly_PLAYHALTDETAIL_HT1_Mapper extends
	...
	public static class CDByColsLly_PLAYHALTDETAIL_HT1_Reducer extends
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_PLAYHALTDETAIL_HT1");
		job.setJarByClass(CDByColsLlyMR_PLAYHALTDETAIL_HT1.class);
		...
		job.setMapperClass(CDByColsLly_PLAYHALTDETAIL_HT1_Mapper.class);
		job.setReducerClass(CDByColsLly_PLAYHALTDETAIL_HT1_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		int nRet = 0;
		nRet = ToolRunner.run(new Configuration(), new CDByColsLlyMR_PLAYHALTDETAIL_HT1(),
