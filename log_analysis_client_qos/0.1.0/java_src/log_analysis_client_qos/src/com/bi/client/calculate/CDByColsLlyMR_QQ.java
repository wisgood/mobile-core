 ...
 * 
 */
public class CDByColsLlyMR_QQ extends Configured implements Tool
{

	public static class CDByColsLly_QQ_Mapper extends
			Mapper<LongWritable, Text, Text, LongWritable>
	{
				...
				InterruptedException
		{
			...
			if ("PlayErrorEnum".equals(this.enumName))
			{
				if ("1".equals(this.formatFields[PlayErrorEnum.O_QQCLICK.ordinal()]))
				{
					// key的第一部分（真正的维度）
	...
	public static class CDByColsLly_QQ_Reducer extends
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_QQ");
		job.setJarByClass(CDByColsLlyMR_QQ.class);
		...
		job.setMapperClass(CDByColsLly_QQ_Mapper.class);
		job.setReducerClass(CDByColsLly_QQ_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		int nRet = 0;
		nRet = ToolRunner.run(new Configuration(), new CDByColsLlyMR_QQ(),
