 ...
 * 
 */
public class CDByColsLlyMR_PLAYBUFFERING_PRN0_SDN0_BTG10 extends Configured implements Tool
{

	public static class CDByColsLly_PLAYBUFFERING_PRN0_SDN0_BTG10_Mapper extends
			Mapper<LongWritable, Text, Text, LongWritable>
	{
				...
				InterruptedException
		{
			...
			{
				//@formatter:off
				long prn = Long.parseLong(this.formatFields[PlayBufferingEnum.PRN_FORMAT.ordinal()]);
				long sdn = Long.parseLong(this.formatFields[PlayBufferingEnum.SDN_FORMAT.ordinal()]);
				long bt  = Long.parseLong(this.formatFields[PlayBufferingEnum.BT_FORMAT.ordinal()]);
				//@formatter:on

				if (0 == prn && 0 == sdn && 10000 < bt)
				{
					// key的第一部分（真正的维度）
	...
	public static class CDByColsLly_PLAYBUFFERING_PRN0_SDN0_BTG10_Reducer extends
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_PLAYBUFFERING_PRN0_SDN0_BTG10");
		job.setJarByClass(CDByColsLlyMR_PLAYBUFFERING_PRN0_SDN0_BTG10.class);
		...
		job.setMapperClass(CDByColsLly_PLAYBUFFERING_PRN0_SDN0_BTG10_Mapper.class);
		job.setReducerClass(CDByColsLly_PLAYBUFFERING_PRN0_SDN0_BTG10_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		nRet = ToolRunner.run(new Configuration(),
				new CDByColsLlyMR_PLAYBUFFERING_PRN0_SDN0_BTG10(),
