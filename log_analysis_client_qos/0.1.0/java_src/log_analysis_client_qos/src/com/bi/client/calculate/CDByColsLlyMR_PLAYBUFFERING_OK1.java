 ...
 * 
 */
public class CDByColsLlyMR_PLAYBUFFERING_OK1 extends Configured implements Tool
{

	public static class CDByColsLly_PLAYBUFFERING_OK1_Mapper extends Mapper<LongWritable, Text, Text, LongWritable>
	{
	...
	public static class CDByColsLly_PLAYBUFFERING_OK1_Reducer extends Reducer<Text, LongWritable, Text, LongWritable>
	{
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_PLAYBUFFERING_OK1");
		job.setJarByClass(CDByColsLlyMR_PLAYBUFFERING_OK1.class);
		...
		job.setMapperClass(CDByColsLly_PLAYBUFFERING_OK1_Mapper.class);
		job.setReducerClass(CDByColsLly_PLAYBUFFERING_OK1_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		int nRet = 0;
		nRet = ToolRunner.run(new Configuration(), new CDByColsLlyMR_PLAYBUFFERING_OK1(),
