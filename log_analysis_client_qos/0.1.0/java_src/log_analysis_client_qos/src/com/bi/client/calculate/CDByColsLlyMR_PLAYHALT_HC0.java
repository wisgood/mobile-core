...
import com.bi.client.datadefine.PlayHaltEnum;
 ...
 * 
 */
public class CDByColsLlyMR_PLAYHALT_HC0 extends Configured implements Tool
{

	public static class CDByColsLly_PLAYHALT_HC0_Mapper extends
			Mapper<LongWritable, Text, Text, LongWritable>
	{
				...
				InterruptedException
		{
			...
			if ("PlayHaltEnum".equals(this.enumName))
			{
				long hc = Long.parseLong(this.formatFields[PlayHaltEnum.HC_FORMAT.ordinal()]);
	...
	public static class CDByColsLly_PLAYHALT_HC0_Reducer extends
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_PLAYHALT_HC0");
		job.setJarByClass(CDByColsLlyMR_PLAYHALT_HC0.class);
		...
		job.setMapperClass(CDByColsLly_PLAYHALT_HC0_Mapper.class);
		job.setReducerClass(CDByColsLly_PLAYHALT_HC0_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		int nRet = 0;
		nRet = ToolRunner.run(new Configuration(), new CDByColsLlyMR_PLAYHALT_HC0(),
