...
public enum PlayHaltEnum
{
	...
	{
		PlayHaltEnum[] enumFields = PlayHaltEnum.values();
		Set<String> fieldsSet = new HashSet<String>();
		for (PlayHaltEnum field : enumFields)
		{
	...
	{
		PlayHaltEnum[] enumFields = PlayHaltEnum.values();
		for (PlayHaltEnum singleEnum : enumFields)
		{
		...
		throw new CustomEnumFieldNotFoundException(PlayHaltEnum.class.getName(), fieldName);
	}
