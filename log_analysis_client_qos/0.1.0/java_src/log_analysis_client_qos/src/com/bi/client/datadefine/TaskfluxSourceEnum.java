...
public enum TaskfluxSourceEnum
{
	...
	{
		TaskfluxSourceEnum[] enumFields = TaskfluxSourceEnum.values();
		Set<String> fieldsSet = new HashSet<String>();
		for (TaskfluxSourceEnum field : enumFields)
		{
	...
	{
		TaskfluxSourceEnum[] enumFields = TaskfluxSourceEnum.values();
		for (TaskfluxSourceEnum singleEnum : enumFields)
		{
		...
		throw new CustomEnumFieldNotFoundException(TaskfluxSourceEnum.class.getName(), fieldName);
	}
