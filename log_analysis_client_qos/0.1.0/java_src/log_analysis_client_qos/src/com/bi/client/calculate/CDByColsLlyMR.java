...
public class CDByColsLlyMR extends Configured implements Tool
{
	...
	public static class CDByColsLlyMapper extends Mapper<LongWritable, Text, Text, LongWritable>
	{
	...
	public static class CDByColsLlyReducer extends Reducer<Text, LongWritable, Text, LongWritable>
	{
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setMapperClass(CDByColsLlyMapper.class);
		job.setReducerClass(CDByColsLlyReducer.class);
