...
public enum DtjsEnum
{
	...
	{
		DtjsEnum[] enumFields = DtjsEnum.values();
		Set<String> fieldsSet = new HashSet<String>();
		for (DtjsEnum field : enumFields)
		{
	...
	{
		DtjsEnum[] enumFields = DtjsEnum.values();
		for (DtjsEnum singleEnum : enumFields)
		{
		...
		throw new CustomEnumFieldNotFoundException(DtjsEnum.class.getName(), fieldName);
	}
