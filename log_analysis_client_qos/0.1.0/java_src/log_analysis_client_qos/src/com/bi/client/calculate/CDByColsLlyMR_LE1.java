 ...
 * 
 */
public class CDByColsLlyMR_LE1 extends Configured implements Tool
{

	public static class CDByColsLly_LE1_Mapper extends
	...
	public static class CDByColsLly_LE1_Reducer extends
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_LE1");
		job.setJarByClass(CDByColsLlyMR_LE1.class);
		...
		job.setMapperClass(CDByColsLly_LE1_Mapper.class);
		job.setReducerClass(CDByColsLly_LE1_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		int nRet = 0;
		nRet = ToolRunner.run(new Configuration(), new CDByColsLlyMR_LE1(),
