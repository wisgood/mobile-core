...
public enum InlinePageEnum
{
	...
	{
		InlinePageEnum[] enumFields = InlinePageEnum.values();
		Set<String> fieldsSet = new HashSet<String>();
		for (InlinePageEnum field : enumFields)
		{
	...
	{
		InlinePageEnum[] enumFields = InlinePageEnum.values();
		for (InlinePageEnum singleEnum : enumFields)
		{
		...
		throw new CustomEnumFieldNotFoundException(InlinePageEnum.class.getName(), fieldName);
	}
