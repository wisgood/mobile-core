 ...
 * 
 */
public class CDByColsLlyMR_PLAYBUFFERING_OK0BTG20 extends Configured implements Tool
{

	public static class CDByColsLly_PLAYBUFFERING_OK0BTG20_Mapper extends
	...
	public static class CDByColsLly_PLAYBUFFERING_OK0BTG20_Reducer extends
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_PLAYBUFFERING_OK0BTG20");
		job.setJarByClass(CDByColsLlyMR_PLAYBUFFERING_OK0BTG20.class);
		...
		job.setMapperClass(CDByColsLly_PLAYBUFFERING_OK0BTG20_Mapper.class);
		job.setReducerClass(CDByColsLly_PLAYBUFFERING_OK0BTG20_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		int nRet = 0;
		nRet = ToolRunner.run(new Configuration(), new CDByColsLlyMR_PLAYBUFFERING_OK0BTG20(),
