...
import com.bi.client.datadefine.BootEnum;
 ...
 * 
 */
public class CDByColsLlyMR_BOOT_ERRORCODEG0 extends Configured implements Tool
{

	public static class CDByColsLly_BOOT_ERRORCODEG0_Mapper extends
			Mapper<LongWritable, Text, Text, LongWritable>
	{
				...
				InterruptedException
		{
			...
			if ("BootEnum".equals(this.enumName))
			{
				int error_code;
				try
				{
					error_code = Integer.parseInt(this.formatFields[BootEnum.ERROR_CODE.ordinal()]);
				}
	...
	public static class CDByColsLly_BOOT_ERRORCODEG0_Reducer extends
	...
	public int run(String[] argv) throws Exception
	{
		...
		job.setJobName("CDByColsLlyMR_BOOT_ERRORCODEG0");
		job.setJarByClass(CDByColsLlyMR_BOOT_ERRORCODEG0.class);
		...
		job.setMapperClass(CDByColsLly_BOOT_ERRORCODEG0_Mapper.class);
		job.setReducerClass(CDByColsLly_BOOT_ERRORCODEG0_Reducer.class);
	...
	public static void main(String[] argv) throws Exception
	{
		...
		int nRet = 0;
		nRet = ToolRunner.run(new Configuration(), new CDByColsLlyMR_BOOT_ERRORCODEG0(),
