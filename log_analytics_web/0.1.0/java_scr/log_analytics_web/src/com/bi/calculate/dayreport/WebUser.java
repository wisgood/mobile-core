...
public class WebUser extends Configured implements Tool
{
	public static class Map extends Mapper<LongWritable, Text, Text, Text> 
	{
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException
		{
			...
			//url level 1 pos is [7]; fck pos is [23]; url1==1 =>www
			if(fields.length > 25)
			{
	...
	public int run(String[] argv) throws Exception
	{
		...
		Job job = new Job(conf, "DistinctUrl1");
		job.setJarByClass(WebUser.class);
	...
	{
		int nRet = 0;
		nRet = ToolRunner.run( new Configuration(), new WebUser(), argv );
