...
/**
 * 
 * @ClassName: TrafficAnalyzer
 * @Description: 流量分析
 * @author liuyn
 * @date July 25, 2013 6:49:31 AM
 */

public class TrafficAnalyzer extends Configured implements Tool {

    private static final String SEPARATOR = "\t";
    
    private static final int[] PAGETYPEIDARR = {1,11,12,13,17};

    public static class TrafficSummaryMapper extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            if("1".equals(urlFirstIdStr) && referThirdId > 1000){
                context.write(new Text(dateIdStr + SEPARATOR + referThirdId),
    ...
    public static class TrafficSummaryReducer extends
    ...
    public static void main(String[] args) throws Exception {
        ...
        nRet = ToolRunner.run(new Configuration(), new TrafficAnalyzer(),
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "TrafficAnalyzer");
        ...
        job.setMapperClass(TrafficSummaryMapper.class);
        job.setReducerClass(TrafficSummaryReducer.class);
